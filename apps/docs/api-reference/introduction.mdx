---
title: 'Introduction'
description: 'Welcome to the API documentation for Feedbackthing'
---

## Welcome

Welcome to the API documentation for Feedbackthing. There are two different API's available: 
<AccordionGroup>
...
<Card
  ...
  icon="key"
  href="https://dash.feedbackthing.pro/settings/general"
>
...
```typescript
const response = await fetch('https://api.feedbackthing.pro/v1', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer fbt_xxxxxxxxxxxxxxxxxxxx',
  },
})
```