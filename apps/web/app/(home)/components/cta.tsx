      ...
      <div className="flex flex-col items-center gap-8 rounded-md bg-muted p-4 text-center lg:p-14">
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-xl text-lg text-muted-foreground leading-relaxed tracking-tight">
            Feedbackthing is the simplest way to listen to your users and
            improve your product. Set up your feedback hub now and start
        ...
        <div className="flex flex-row gap-4">
          <Button className="gap-4" variant="outline" asChild>
            <Link href="/contact">
              See demo page <PhoneCall className="h-4 w-4" />
            </Link>
          </Button>
