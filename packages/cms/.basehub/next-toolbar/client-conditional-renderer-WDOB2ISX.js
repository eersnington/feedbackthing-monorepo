...
// ../../node_modules/.pnpm/basehub@7.5.28_@babel+runtime@7.24.6_@types+react@19.0.1_enquirer@2.4.1_react-dom@19.0.0_reac_dg3unnfihpy5trh74sikmblzsq/node_modules/basehub/src/next/toolbar/client-conditional-renderer.tsx
import * as React from "react";
import { createPortal } from "react-dom";
var LazyClientToolbar = React.lazy(
  () => import("./client-toolbar-FAZLTTGL.js").then((mod) => ({ default: mod.ClientToolbar }))
);
