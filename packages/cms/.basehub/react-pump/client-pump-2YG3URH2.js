...
// ../../node_modules/.pnpm/basehub@7.5.28_@babel+runtime@7.24.6_@types+react@19.0.1_enquirer@2.4.1_react-dom@19.0.0_reac_dg3unnfihpy5trh74sikmblzsq/node_modules/basehub/src/react/pump/client-pump.tsx
import * as React from "react";
import { replaceSystemAliases } from "../runtime/_aliasing.js";

// ../../node_modules/.pnpm/sonner@1.5.0_react-dom@19.0.0_react@19.0.0__react@19.0.0/node_modules/sonner/dist/index.mjs
import e from "react";
...
var It = ({ visible: s }) => E.createElement("div", { className: "sonner-loading-wrapper", "data-visible": s }, E.createElement("div", { className: "sonner-spinner" }, Ft.map((o, t) => E.createElement("div", { className: "sonner-loading-bar", key: `spinner-bar-${t}` }))));
var $t = E.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", height: "20", width: "20" }, E.createElement("path", { fillRule: "evenodd", d: "M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z", clipRule: "evenodd" }));
var Wt = E.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", height: "20", width: "20" }, E.createElement("path", { fillRule: "evenodd", d: "M9.401 3.003c1.155-2 4.043-2 5.197 0l7.355 12.748c1.154 2-.29 4.5-2.599 4.5H4.645c-2.309 0-3.752-2.5-2.598-4.5L9.4 3.003zM12 8.25a.75.75 0 01.75.75v3.75a.75.75 0 01-1.5 0V9a.75.75 0 01.75-.75zm0 8.25a.75.75 0 100-1.5.75.75 0 000 1.5z", clipRule: "evenodd" }));
var _t = E.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", height: "20", width: "20" }, E.createElement("path", { fillRule: "evenodd", d: "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a.75.75 0 000 1.5h.253a.25.25 0 01.244.304l-.459 2.066A1.75 1.75 0 0010.747 15H11a.75.75 0 000-1.5h-.253a.25.25 0 01-.244-.304l.459-2.066A1.75 1.75 0 009.253 9H9z", clipRule: "evenodd" }));
var Ut = E.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", height: "20", width: "20" }, E.createElement("path", { fillRule: "evenodd", d: "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-5a.75.75 0 01.75.75v4.5a.75.75 0 01-1.5 0v-4.5A.75.75 0 0110 5zm0 10a1 1 0 100-2 1 1 0 000 2z", clipRule: "evenodd" }));
var Dt = () => {
  let [s, o] = kt.useState(document.hidden);
  return kt.useEffect(() => {
    let t = () => {
      o(document.hidden);
    };
...
var se = (s) => {
  ...
  let { invert: o, toast: t, unstyled: n, interacting: h, setHeights: u, visibleToasts: g, heights: b, index: d, toasts: q, expanded: $, removeToast: V, defaultRichColors: Q, closeButton: i, style: O, cancelButtonStyle: K, actionButtonStyle: Z, className: tt = "", descriptionClassName: et = "", duration: X, position: ot, gap: w, loadingIcon: j, expandByDefault: W, classNames: r, icons: I, closeButtonAriaLabel: at = "Close toast", pauseWhenPageIsHidden: k, cn: T } = s, [z, nt] = e.useState(false), [D, H] = e.useState(false), [st, N] = e.useState(false), [M, rt] = e.useState(false), [c, m] = e.useState(0), [y, S] = e.useState(0), A = e.useRef(null), l = e.useRef(null), _ = d === 0, J = d + 1 <= g, x = t.type, P = t.dismissible !== false, Mt = t.className || "", At = t.descriptionClassName || "", G = e.useMemo(() => b.findIndex((a) => a.toastId === t.id) || 0, [b, t.id]), Lt = e.useMemo(() => {
    var a;
    return (a = t.closeButton) != null ? a : i;
  }, [t.closeButton, i]), mt = e.useMemo(() => t.duration || X || Zt, [t.duration, X]), it = e.useRef(0), Y = e.useRef(0), pt = e.useRef(0), F = e.useRef(null), [gt, zt] = ot.split("-"), ht = e.useMemo(() => b.reduce((a, f, p) => p >= G ? a : a + f.height, 0), [b, G]), bt = Dt(), jt = t.invert || o, lt = x === "loading";
  Y.current = e.useMemo(() => G * w + ht, [G, ht]), e.useEffect(() => {
    nt(true);
  }, []), e.useLayoutEffect(() => {
    if (!z)
      return;
  ...
  }, [$, h, W, t, mt, L, t.promise, x, k, bt]), e.useEffect(() => {
    let a = l.current;
    if (a) {
...
var Te = (s) => {
  let { invert: o, position: t = "bottom-right", hotkey: n = ["altKey", "KeyT"], expand: h, closeButton: u, className: g, offset: b, theme: d = "light", richColors: q, duration: $, style: V, visibleToasts: Q = qt, toastOptions: i, dir: O = Ht(), gap: K = ee, loadingIcon: Z, icons: tt, containerAriaLabel: et = "Notifications", pauseWhenPageIsHidden: X, cn: ot = ne } = s, [w, j] = e.useState([]), W = e.useMemo(() => Array.from(new Set([t].concat(w.filter((c) => c.position).map((c) => c.position)))), [w, t]), [r, I] = e.useState([]), [at, k] = e.useState(false), [T, z] = e.useState(false), [nt, D] = e.useState(d !== "system" ? d : typeof window != "undefined" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), H = e.useRef(null), st = n.join("+").replace(/Key/g, "").replace(/Digit/g, ""), N = e.useRef(null), M = e.useRef(false), rt = e.useCallback((c) => {
    var m;
    (m = w.find((y) => y.id === c.id)) != null && m.delete || v.dismiss(c.id), j((y) => y.filter(({ id: S }) => S !== c.id));
  }, [w]);
  return e.useEffect(() => v.subscribe((c) => {
    if (c.dismiss) {
  ...
  }, [H.current]), w.length ? e.createElement("section", { "aria-label": `${et} ${st}`, tabIndex: -1 }, W.map((c, m) => {
    var A;
    let [y, S] = c.split("-");
    return e.createElement("ol", { key: c, dir: O === "auto" ? Ht() : O, tabIndex: -1, ref: H, className: g, "data-sonner-toaster": true, "data-theme": nt, "data-y-position": y, "data-x-position": S, style: { "--front-toast-height": `${((A = r[0]) == null ? void 0 : A.height) || 0}px`, "--offset": typeof b == "number" ? `${b}px` : b || Qt, "--width": `${te}px`, "--gap": `${K}px`, ...V }, onBlur: (l) => {
...
var ClientPump = ({
      ...
      rawQueries.map(async (rawQueryOp, index) => {
        ...
        const responsePromise = fetch(pumpEndpoint, {
          ...
          headers: {
            ...
            "x-basehub-ref": ref,
            ...lastResponseHash ? { "x-basehub-last-response-hash": lastResponseHash } : void 0
          },
  ...
  React.useEffect(() => {
    if (currentToastRef.current) {
      Jt.dismiss(currentToastRef.current);
    }
    if (!result?.errors)
      return;
    ...
    if (!mainError)
      return;
    currentToastRef.current = Jt.error(
      /* @__PURE__ */ React.createElement("div", { style: { lineHeight: 1.3 } }, "Error fetching data from the BaseHub Draft API:", mainError.message, mainError.path ? /* @__PURE__ */ React.createElement(React.Fragment, null, " ", "at ", /* @__PURE__ */ React.createElement(ToastInlineCode, null, mainError.path?.join("."))) : "", /* @__PURE__ */ React.createElement(
        "p",
        {
          style: {
            opacity: 0.7,
  ...
  React.useEffect(() => {
    ...
    if (!pusherAppKey || !pusherCluster)
      return;
    pusherMounted = true;
    import("./pusher-7KV3LIXO.js").then((mod) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, resolvedChildren ?? initialResolvedChildren, /* @__PURE__ */ React.createElement(Te, { closeButton: true }));
};
var ToastInlineCode = (props) => {
